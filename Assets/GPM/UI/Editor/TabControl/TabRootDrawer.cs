                    ...
                    if (controller != targetController)
                    {
                        if (isLinked == true)
                        {
                            if (controller == null)
                            {
                                ...
                                if (Strings.MessageCheckBox(Strings.KEY_TAB_ERROR_MESSAGE, Strings.KEY_TAB_RELEASE_CONTROL_CHECK_MESSAGE) == true)
                                {
                                    isLinked = false;
                            ...
                            {
                                Strings.MessageBox(Strings.KEY_TAB_ERROR_MESSAGE, Strings.KEY_TAB_CHANGE_CONTROL_CHECK_MESSAGE);
                            }
                        }
                        else
                        {
