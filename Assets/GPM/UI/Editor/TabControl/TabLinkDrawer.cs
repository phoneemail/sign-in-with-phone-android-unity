            ...
            if (link != null)
            {
                ...
                if(tab != linkedTab)
                {
                    if (tab != null)
                    {
                        ...
                        {
                            Strings.MessageBox(Strings.KEY_TAB_ERROR_MESSAGE, Strings.KEY_CONTROL_ADDTAB_ONLYONE_MESSAGE);
                        }
                        else
                        {
                                ...
                                linkedGroup.Check(group) == false)
                            {
                                ...
                                if (Strings.MessageCheckBox(Strings.KEY_TAB_ERROR_MESSAGE, Strings.KEY_CONTROL_ADDTAB_CHECK_MESSAGE) == true)
                                {
                                    link.SetTab(tab);
                                }
                            }
