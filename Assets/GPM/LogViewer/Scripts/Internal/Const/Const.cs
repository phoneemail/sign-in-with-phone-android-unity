namespace Gpm.LogViewer.Internal
{
    ...
    {
        public const string ERROR                                   = "<color=#ff0000>Error</color>";
        public const string WARNING                                 = "<color=#fff400>Warning</color>";
    }
    ...
    public static class LogConst
    {
        ...
        public const string LOGFILE_NAME                            = "GpmLogViewerLogForMail.txt";
        public const string LOGMAIL_SUBJECT_FORMAT                  = "[GPM LogViewer][{0}] {1}";
        public const string LOGMAIL_BODY                            = "Log from GPM LogViewer. Please refer to the attached file.";
