namespace Gpm.CacheStorage.Internal
{
    ...
    internal static class CacheStorageImplement
    {
        ...
        internal static CacheRequestOperation Request(string url, CacheRequestType requestType, double reRequestTime, Action<GpmCacheResult> onResult)
        {
            if (Initialized == false)
            {
                GpmLogger.Error("Not initialized", NAME, typeof(CacheStorageImplement));
        ...
        internal static CacheRequestOperation RequestHttpCache(string url, Action<GpmCacheResult> onResult)
        {
            if (Initialized == false)
            {
                GpmLogger.Error("Not initialized", NAME, typeof(CacheStorageImplement));
        ...
        internal static CacheRequestOperation RequestLocalCache(string url, Action<GpmCacheResult> onResult)
        {
            if (Initialized == false)
            {
                GpmLogger.Error("Not initialized", NAME, typeof(CacheStorageImplement));
        ...
        internal static CacheRequestOperation RequestTexture(string url, CacheRequestType requestType, double reRequestTime, bool preLoad, Action<CachedTexture> onResult)
        {
            if (Initialized == false)
            {
                GpmLogger.Error("Not initialized", NAME, typeof(CacheStorageImplement));
