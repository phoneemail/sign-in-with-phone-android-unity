...
namespace Gpm.CacheStorage.Formatters
{
    ...
    public sealed class CacheInfoFormatter : IMessagePackFormatter<CacheInfo>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, CacheInfo value, IFormatterResolver formatterResolver)
        {
            ...
            offset += formatterResolver.GetFormatterWithVerify<StringToValueHttpTime>().Serialize(ref bytes, offset, value.lastModified, formatterResolver);
            offset += MessagePackBinary.WriteInt64(ref bytes, offset, value.lastAccess);
            offset += formatterResolver.GetFormatterWithVerify<StringToValueHttpTime>().Serialize(ref bytes, offset, value.expires, formatterResolver);
            ...
            offset += formatterResolver.GetFormatterWithVerify<StringToValueHttpTime>().Serialize(ref bytes, offset, value.date, formatterResolver);
        ...
        public CacheInfo Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (key)
                {
                    ...
                    case 2:
                        {
                            __lastModified__ = formatterResolver.GetFormatterWithVerify<StringToValueHttpTime>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    case 3:
                        {
                    ...
                    case 4:
                        {
                            __expires__ = formatterResolver.GetFormatterWithVerify<StringToValueHttpTime>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    case 5:
                        {
                    ...
                    case 8:
                        {
                            __date__ = formatterResolver.GetFormatterWithVerify<StringToValueHttpTime>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    case 9:
                        {
    ...
    public sealed class CachePackageFormatter : IMessagePackFormatter<CachePackage>
    {
        public int Serialize(ref byte[] bytes, int offset, CachePackage value, IFormatterResolver formatterResolver)
        {
            ...
            offset += formatterResolver.GetFormatterWithVerify<StringToValueHttpTime>().Serialize(ref bytes, offset, value.lastRemoveTime, formatterResolver);
            return offset - startOffset;
        }
        ...
        public CachePackage Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (key)
                {
                    ...
                    case 5:
                        {
                            __lastRemoveTime__ = formatterResolver.GetFormatterWithVerify<StringToValueHttpTime>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    default:
                        {
