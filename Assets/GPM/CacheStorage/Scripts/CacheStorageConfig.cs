...
namespace Gpm.CacheStorage
{
    internal class CacheStorageConfig
    {
        ...
        internal CacheStorageConfig(int maxCount, int maxSize, double reRequestTime, double unusedPeriodTime, double removeCycle, CacheRequestType defaultRequestType)
        {
