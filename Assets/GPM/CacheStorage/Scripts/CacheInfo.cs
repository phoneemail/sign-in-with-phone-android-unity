...
namespace Gpm.CacheStorage
{
    ...
    public class CacheInfo : IComparable<CacheInfo>
    {
        ...
        [SerializeField]
        public StringToValueHttpTime lastModified;

        [SerializeField]
        public long lastAccess;

        [SerializeField]
        public StringToValueHttpTime expires;
        ...
        [SerializeField]
        public StringToValueHttpTime date;
        ...
        {
            onResult?.SafeCallback(new GpmCacheResult(this, datas, updateData));
